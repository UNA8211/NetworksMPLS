...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H2': 1, 'H1': 0}    # table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = {'H2': 'RB', 'H1': 'H1'}     # table used to forward MPLS frames
    decap_tbl_D = {'H2': 0, 'H1': 1}    # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {'H2': 0, 'H1': 1}
    frwd_tbl_D = {'H2': 'H2', 'H1': 'RA'}
    decap_tbl_D = {'H2': 1, 'H1': 0}
